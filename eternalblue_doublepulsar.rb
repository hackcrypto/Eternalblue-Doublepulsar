...
class MetasploitModule < Msf::Exploit::Remote
  ...
  def initialize(info = {})
	...
	register_options([
		...
		OptString.new('ETERNALBLUEPATH',[true,'Path directory of Eternalblue','usr/share/metasploit-framework/modules/exploit/windows/smb/deps']),
		OptString.new('DOUBLEPULSARPATH',[true,'Path directory of Doublepulsar','/root/Eternalblue-Doublepulsar-Metasploit/deps']),
		OptString.new('WINEPATH',[true,'WINE drive_c path','usr/share/metasploit-framework/modules/exploit/windows/smb/deps']),
